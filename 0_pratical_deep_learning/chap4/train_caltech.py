...
log_filename = 'caltech101_' + now.strftime('%Y-%m-%d-%H-%M-%S') + '.json'
...
chainer.serializers.save_npz('caltech_chain.npz', network)
chainer.serializers.save_npz('caltech_optimizer.npz', optimizer)
